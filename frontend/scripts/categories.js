...
function editCategory(categoryId) {
  ...
  // Scroll to form
  document.getElementById('categoryForm').scrollIntoView({ behavior: 'smooth', block: 'nearest' });
}
  ...
  try {
    ...
    if (!res.ok) {
      ...
      if (error.transactionCount) {
        alert(`Cannot delete this category because it is used in ${error.transactionCount} transaction(s).\n\nPlease reassign those transactions first.`);
      } else {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Hook up buttons
  document.getElementById('addCategoryBtn').addEventListener('click', () => toggleCategoryForm(true));
  document.getElementById('cancelCategoryBtn').addEventListener('click', () => toggleCategoryForm(false));
